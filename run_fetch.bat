...
:: ── Step 1: Pull ──────────────────────────────────────────────────────────
echo [1/30] Pulling latest from GitHub...
...
echo [2/30] Fetching Telegram @biltiformali...
...
:: ── Step 27: Teva Pharmaceuticals ─────────────────────────────────────────
echo [27/30] Fetching Teva jobs (local only)...
...
echo [28/30] Running source health check...
%PYTHON_CMD% check_health.py
echo.

:: ── Step 29: Upload all CSVs to Google Drive (history archive) ────────────
...
echo [29/30] Uploading CSVs to Google Drive...
...
echo [30/30] Committing and pushing CSVs...
