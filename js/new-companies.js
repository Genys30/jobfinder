...
(function () {
  ...
  var COLW = ["3%", "15%", "8%", "8%", "5%", "10%", "9%", "11%", "11%", "12%", "8%"];
  ...
  function render() {
    ...
    var visibleTotal = showDismissed ? rows.length : rows.length - nDism;
    count.textContent = shown.length === visibleTotal
      ? visibleTotal + " companies" : shown.length + " of " + visibleTotal;
