...
(function () {
  ...
  async function renderOverview(body) {
    try {
      ...
      var ntaOld = (meta.nta_age_days || 0) > 8;
      ...
      var cards = [
        ...
        stage("NLI freshness", meta.nli_age_days != null ? meta.nli_age_days + "d old" : "—",
          "re-saved by hand about weekly", nliOld ? "WARN" : "OK",
          "NLI is over 8 days old — re-save nli_career.html, then Actions › “Refresh NLI”."),
        stage("NTA freshness", meta.nta_age_days != null ? meta.nta_age_days + "d old" : "—",
          "re-saved by hand about weekly", ntaOld ? "WARN" : "OK",
          "NTA is over 8 days old — re-save nta_career.html, then Actions › “Refresh NTA”."),
